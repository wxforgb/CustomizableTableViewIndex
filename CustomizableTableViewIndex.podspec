#
#  Be sure to run `pod spec lint CustomizableTableViewIndex.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "wang xin" => "mailtowangxin@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/wxforgb/CustomizableTableViewIndex.git", :tag => "#{spec.version}" }
